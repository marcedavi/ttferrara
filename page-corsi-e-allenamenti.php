...
<section class="container mb-8">
    ...
    <div class="image-and-text-right">
        ...
        <div>
            <h3>Amatori</h3>
            <p>Dedicati agli adulti che voglio imparare o rispolverare il Tennis Tavolo. Sempre seguiti dal tecnico Maurizio Buzzone il <span class="text-red-800">Martedì</span> e il <span class="text-red-800">Giovedì</span> dalle <span class="text-red-800">20:00</span> alle <span class="text-red-800">21:30</span>.</p>
        </div>
    </div>
